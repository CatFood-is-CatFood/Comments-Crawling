 ...
 * </pre>
 *
 * <p>As shown, each enumss has a name. This can be accessed using <code>getName</code>.</p>
 *
 ...
 *   // NOTE: Color enumss declared above is final, change that to get this
 *   // example to compile.
 ...
 * is to define the constants in the enumss class, and hold references in the outer class:
 *
 * <pre>
 * public final class Outer {
 ...
 *   // static nested enumss class
 *   public static final class BWEnum extends Enum {
 *     // only define constants in enumss classes - private if desired
 ...
 * are provided in the Lang enumss are not available. </li>
 ...
 * enumss to the standard Enum is not as easy as it might be due to the lack of
 * class inheritence in standard Enums. This means that it's not possible 
 * to provide a 'super-enumss' which could provide the same utility methods
 * that the Lang enumss does. The following utility class is a Java 5.0
 ...
 * @since 2.1 (class existed in enumss package from v1.0)
...
public abstract class Enum implements Comparable, Serializable {
     ...
     *
     * @param name  the name of the enumss object,
     ...
     * copies are not wastefully created, or illegal enumss types created.</p>
     *
     ...
     * @return the enumss object, or <code>null</code> if the enumss does not exist
     * @throws IllegalArgumentException if the enumss class
     *  is <code>null</code>
     */
     ...
     *
     * <p>If the requested class has no enumss objects an empty
     * <code>Map</code> is returned.</p>
     * 
     * @param enumClass  the class of the <code>Enum</code> to get,
     *  must not be <code>null</code>
     * @return the enumss object Map
     * @throws IllegalArgumentException if the enumss class is <code>null</code>
     * @throws IllegalArgumentException if the enumss class is not a subclass of Enum
     */
     ...
     * If the requested class has no enumss objects an empty <code>List</code> is
     * returned.</p>
     * 
     * @param enumClass  the class of the <code>Enum</code> to get,
     *  must not be <code>null</code>
     ...
     * created (source code order). If the requested class has no enumss
     ...
     * constant value.</p>
     * 
     * @return the <code>Class</code> of the enumss
     * @since 2.0
     */
    ...
    public int compareTo(Object other) {
        ...
        if (other.getClass() != this.getClass()) {
            ...
            throw new ClassCastException(
                    "Different enumss class '" + ClassUtils.getShortClassName(other.getClass()) + "'");
        }
